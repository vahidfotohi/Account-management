...
mixin _$Worker {
  ...
  WageType get wageType => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      wageType: null == wageType
          ? _value.wageType
          : wageType // ignore: cast_nullable_to_non_nullable
              as WageType,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.wageType, wageType) ||
                other.wageType == wageType) &&
...
abstract class _Worker implements Worker {
  const factory _Worker(
      ...
      final String? jobTitle,
      required final WageType wageType,
